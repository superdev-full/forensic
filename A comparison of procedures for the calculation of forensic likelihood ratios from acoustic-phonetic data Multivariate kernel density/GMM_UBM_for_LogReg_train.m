function [log_scores_train_LogReg_ss, log_scores_train_LogReg_ds] = GMM_UBM_for_LogReg_train(data, Indices_Speakers, Indices_Sessions, num_gaussians, max_adaption_iter, avoid_non_psd, stat_options)
