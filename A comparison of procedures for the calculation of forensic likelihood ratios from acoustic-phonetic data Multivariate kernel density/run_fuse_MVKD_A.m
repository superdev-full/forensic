...
for I_vowel = which_vowel
    load(['.\results\', data_set_prefix, '_', vowel_labels{I_vowel}, '.mat'], 'log_scores_train_LogReg_ss', 'log_scores_train_LogReg_ds', 'log_scores', 'Indices_comparisons');
...
clear log_scores_train_LogReg_ss log_scores_train_LogReg_ds
...
% save(['.\results\', save_name, '.mat'], 'log_LR_fused', 'Indices_comparisons', 'Cllr_fused', 'Cllr_min_fused', 'best_num_iter');
