...
% output to txt file
text_output_file = '.\resultsB\MVKD2 Cllr results.txt';
...
for I_vowel = which_vowel
    ...
    % reverse session labels [change 1 to 2, change 2 to 1]
    Indices_Sessions = 3 - Indices_Sessions;
    ...
    save(['.\resultsB\', save_name, '.mat'], 'log_scores_train_LogReg_ss', 'log_scores_train_LogReg_ds', 'log_scores', 'log_LR_cal', 'Indices_comparisons', 'Cllr_raw', 'Cllr_cal', 'Cllr_min_raw', 'Cllr_min_cal');
